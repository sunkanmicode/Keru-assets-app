...
import BuyDataBottomSheet from '../BuyDataBottomSheet';


const ReviewOrderComp = () => {
    const navigation = useNavigation()
     const BuyDataSheetRef = React.useRef(null);

     const height = 343;

     const buyDataCloseSheet = () => {
       if (BuyDataSheetRef.current) {
         BuyDataSheetRef.current.close();
       }
     };
     const buyDataOpenSheet = () => {
       if (BuyDataSheetRef.current) {
         BuyDataSheetRef.current.open();
       }
     };
  return (
    <>
